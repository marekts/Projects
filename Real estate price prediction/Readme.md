This project is part of Kaggle 'House prices' competition. I will use supervised machine learning in order to built model which will be predict house prices based on house parameters.
